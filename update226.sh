...
mkdir -p src/app/api/debug/find-next-valid
cat > src/app/api/debug/find-next-valid/route.ts << 'EOF'
...
EOF
echo "✅ Next valid message finder created"

echo ""
echo "===== AFTER DEPLOY ====="
echo "Run this to find the FIRST real, un-imported prompt:"
echo "  https://promptsfa.ir/api/debug/find-next-valid?key=pv-cron-8x2m1q&start=31&max=100"
echo "=================================="
