...
mkdir -p src/app/api/debug/migrate-to-tg-links
cat > src/app/api/debug/migrate-to-tg-links/route.ts << 'EOF'
...
EOF
echo "✅ Migration route created"

echo ""
echo "===== FINAL MIGRATION STEP ====="
echo "This will convert old internal links to direct Telegram links (Zero image download)."
echo ""
echo "Run this to migrate the first 50 prompts:"
echo "  https://promptsfa.ir/api/debug/migrate-to-tg-links?key=pv-cron-8x2m1q&batch=50&offset=0"
echo ""
echo "If successful, it will give you a 'nextUrl' to continue the next 50."
echo "=================================="
