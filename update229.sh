...
mkdir -p src/app/api/debug/full-channel-scan
cat > src/app/api/debug/full-channel-scan/route.ts << 'EOF'
...
EOF
echo "✅ Full channel scanner created"

echo ""
echo "===== AFTER DEPLOY ====="
echo ""
echo "Step 1: Scan first 200 messages (1-200)"
echo "  https://promptsfa.ir/api/debug/full-channel-scan?key=pv-cron-8x2m1q&start=1&end=200"
echo ""
echo "Step 2: Continue scanning (201-400)"
echo "  https://promptsfa.ir/api/debug/full-channel-scan?key=pv-cron-8x2m1q&start=201&end=400"
echo ""
echo "Step 3: Continue until you reach 1884"
echo "  (Repeat with start=401&end=600, start=601&end=800, etc.)"
echo ""
echo "=================================="
